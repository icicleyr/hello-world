...
{
    /// <summary>
    /// The supported tracked hand joints.手关节
    /// </summary>
    ...
    public enum TrackedHandJoint
    {
        ...
        Palm,
        /// <summary>
        /// The lowest joint in the thumb (down in your palm).拇指的最低关节（手掌向下）
        /// </summary>
        ThumbMetacarpalJoint,
        /// <summary>
        /// The thumb's second (middle-ish) joint.拇指的第二个（中间）关节
        /// </summary>
        ThumbProximalJoint,
        /// <summary>
        /// The thumb's first (furthest) joint.拇指的第一个（最远）关节
        /// </summary>
        ThumbDistalJoint,
        /// <summary>
        /// The tip of the thumb.拇指尖。
        /// </summary>
        ThumbTip,
        /// <summary>
