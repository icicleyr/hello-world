...
namespace Microsoft.MixedReality.Toolkit.Input
{
    ...
    /// All replacement systems for providing Input System functionality should derive(派生) from this interface
    /// </summary>
    public interface IMixedRealityInputSystem : IMixedRealityEventSystem
    {
        ...
        /// <summary>
        /// List of the Interaction Input Sources as detected(检测到) by the input manager like hands or motion controllers.
        /// </summary>
        ...
        /// <summary>
        /// Typed representation表示 of the ConfigurationProfile property.（Configuration组态、构造、表面配置； Profile轮廓）
        /// </summary>
